...
const List = React.memo(({
    ...
    if (isEditing) {
        return (
            <div className={`bg-gray-100 flex item-center justify-between w-full px-4 py-1 my-2 text-gray-600 border rounded`}>
        ...
        return (
            <div key={id} {...provided.draggableProps} ref={provided.innerRef} {...provided.dragHandleProps}
                className={`${snapshot.isDragging ? "bg-gray-400" : "bg-gray-100"} flex item-center justify-between w-full px-4 py-1 my-2 text-gray-600 border rounded`}>
                <div className='items-center'>
                    <input
                        type="checkbox"
